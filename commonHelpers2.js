        ...
        <li class="discount-product">
         ...
         <img class="discount-svg" src="${k}" alt="discount-icon" width="60" height="60"/>
           ...
           <button class="discount-check " type="button">
                <img class="discount-check-svg" src="${C}" alt="shop-icon" width="18" height="18"/>
