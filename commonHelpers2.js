import{s as P,d as y,e as h,f as p,h as i,i as c,j as C,k as L,l as k,m as w,n as E}from"./assets/workWithCart-ff7b8521.js";import{P as A}from"./assets/vendor-b592f4c5.js";const M="/Second_Team-project-2023/assets/discount-1f26b8b0.svg",T=document.querySelector(".popular-product-list");function _(t){T.insertAdjacentHTML("beforeend",j(t))}function j(t){return t.map(({_id:e,name:a,img:l,category:s,size:d,popularity:u})=>`
    ...
    `).splice(0,2).join("")}const r=document.querySelector("#filterForm");r.addEventListener("submit",O);const H=document.querySelector("#single");r.elements.filterCategories.addEventListener("change",J);r.elements.filterMethod.addEventListener("change",Q);let o;async function f(){c()?(o=c(),o.keyword!==null?(r.filterInput.value=o.keyword,await i(c()).then(t=>{if(console.log(t),t.data.results.length)n(t.data);else if(!Array.isArray(t.data.results)||!t.data.results.length){g();return}})):o.category):y()}f();function I(t){H.insertAdjacentHTML("afterbegin",N(t))}function N(t){const e=t.map(a=>`
    <option value="${a}" class="js-option">${a}</option>
    `);return e.unshift('<option value="" disabled selected>Categories</option>'),e.join("")}function O(t){t.preventDefault();const{filterInput:e,filterCategories:a}=t.target.elements;Z(e,a)}function Z(t,e){t.value.trim().length?t.value.trim()?(o.keyword=t.value.trim(),e.value!==""&&(o.category=e.value),p(o),i(c()).then(a=>{if(console.log(a),a.data.results.length)n(a.data);else if(!Array.isArray(a.data.results)||!a.data.results.length){g();return}}).catch(a=>console.log(a))):e.value&&(o.category=e.value.trim(),p(o),i(c()).then(a=>{if(a.data.results.length)n(a.data);else return}).catch(a=>console.log(a))):(y(),f(),h().then(({data:a})=>{n(a)}).catch(a=>console.log(a)),r.reset())}function J(t){t.preventDefault(),t.target.value==="Show all"&&(h().then(({data:e})=>{n(e)}).catch(e=>console.log(e)),r.reset()),o.category=t.target.value.replaceAll(" ","_").replaceAll("&","%26"),p(o),i(c()).then(e=>{if(e.data.results.length)n(e.data);else if(!Array.isArray(e.data.results)||!e.data.results.length){g();return}}).catch(e=>console.log(e))}function Q(t){if(t.preventDefault(),t.target.value==="Show_all"&&(y(),f(),h().then(({data:e})=>{n(e)}).catch(e=>console.log(e)),r.reset()),t.target.value==="A_to_Z"||t.target.value==="Z_to_A"){t.target.value==="A_to_Z"?o.byABC=!0:o.byABC=!1,o.byPrice=null,o.byPopularity=null,p(o),i(c()).then(e=>{if(e.data.results.length)n(e.data);else{g();return}}).catch(e=>console.log(e));return}else if(t.target.value==="Cheap"||t.target.value==="Expensive"){t.target.value==="Cheap"?o.byPrice=!0:o.byPrice=!1,o.byABC=null,o.byPopularity=null,p(o),i(c()).then(e=>{if(e.data.results.length)n(e.data);else{g();return}}).catch(e=>console.log(e));return}else if(t.target.value==="Popular"||t.target.value==="Not_popular"){t.target.value==="Not_popular"?o.byPopularity=!0:o.byPopularity=!1,o.byABC=null,o.byPrice=null,p(o),i(c()).then(e=>{if(e.data.results.length)n(e.data);else{g();return}}).catch(e=>console.log(e));return}else if(t.target.value==="Show_all"){y();return}}const G=document.querySelector(".product-modal-content"),S=document.querySelector("body");function K(t){const e={openModalBtn:t,closeModalBtn:document.querySelector(".product-modal-close"),modal:document.querySelector(".product-backdrop")};e.openModalBtn.addEventListener("click",a),e.closeModalBtn.addEventListener("click",l);function a(s){const d=document.querySelector(".all-product-btn"),u=document.querySelector(".all-buy-svg");s.target===d||s.target===u||(S.style.overflow="hidden",e.modal.classList.remove("is-hidden"),R(s.currentTarget))}function l(){S.style.overflow="visible",G.innerHTML=`
  ...
  `}const q=document.querySelector(".product-list");function n(t){q.innerHTML=V(t.results),document.querySelectorAll(".product-modal-open").forEach(a=>{a.addEventListener("click",K(a))})}function V(t){return t.map(({_id:e,name:a,img:l,category:s,price:d,size:u,is10PercentOff:m,popularity:B})=>`
        <li class="all-product-card product-modal-open" id="${e}" data-id="${e}">
            <img
