import{s as q,b as h,c as u,d as r,e as d,f as s,h as b,i as S,j as $}from"./assets/localStorage-251d142c.js";import"./assets/vendor-f9e4276b.js";const k="/Second_Team-project-2023/assets/discount-1f26b8b0.svg",B=document.querySelector(".popular-product-list");function M(t){B.insertAdjacentHTML("beforeend",_(t))}function _(t){return t.map(({_id:e,name:o,img:c,category:n,size:m,popularity:f})=>`
    ...
    `).splice(0,2).join("")}const i=document.querySelector("#filterForm");i.addEventListener("submit",F);const D=document.querySelector("#single");i.elements.filterCategories.addEventListener("change",N);i.elements.filterMethod.addEventListener("change",Z);let a;function g(){a=s()?s():h()}g();function x(t){D.insertAdjacentHTML("afterbegin",z(t))}function z(t){const e=t.map(o=>`
    <option value="${o}" class="js-option">${o}</option>
    `);return e.unshift('<option value="" disabled selected>Categories</option>'),e.join("")}function F(t){t.preventDefault();const{filterInput:e,filterCategories:o}=t.target.elements;H(e,o)}function H(t,e){t.value.trim().length?t.value.trim()?(a.keyword=t.value.trim(),e.value!==""&&(a.category=e.value),r(a),d(s()).then(o=>{if(console.log(o),o.data.results.length)l(o.data);else if(!Array.isArray(o.data.results)||!o.data.results.length){p();return}}).catch(o=>console.log(o))):e.value&&(a.category=e.value.trim(),r(a),d(s()).then(o=>{if(o.data.results.length)l(o.data);else return}).catch(o=>console.log(o))):(h(),g(),u().then(({data:o})=>{l(o)}).catch(o=>console.log(o)),i.reset())}function N(t){t.preventDefault(),t.target.value==="Show all"&&(u().then(({data:e})=>{l(e)}).catch(e=>console.log(e)),i.reset()),a.category=t.target.value.replaceAll(" ","_").replaceAll("&","%26"),r(a),d(s()).then(e=>{if(e.data.results.length)l(e.data);else if(!Array.isArray(e.data.results)||!e.data.results.length){p();return}}).catch(e=>console.log(e))}function Z(t){if(t.preventDefault(),t.target.value==="Show_all"&&(h(),g(),u().then(({data:e})=>{l(e)}).catch(e=>console.log(e)),i.reset()),t.target.value==="A_to_Z"||t.target.value==="Z_to_A"){t.target.value==="A_to_Z"?a.byABC=!0:a.byABC=!1,a.byPrice=null,a.byPopularity=null,r(a),d(s()).then(e=>{if(e.data.results.length)l(e.data);else{p();return}}).catch(e=>console.log(e));return}else if(t.target.value==="Cheap"||t.target.value==="Expensive"){t.target.value==="Cheap"?a.byPrice=!0:a.byPrice=!1,a.byABC=null,a.byPopularity=null,r(a),d(s()).then(e=>{if(e.data.results.length)l(e.data);else{p();return}}).catch(e=>console.log(e));return}else if(t.target.value==="Popular"||t.target.value==="Not_popular"){t.target.value==="Not_popular"?a.byPopularity=!0:a.byPopularity=!1,a.byABC=null,a.byPrice=null,r(a),d(s()).then(e=>{if(e.data.results.length)l(e.data);else{p();return}}).catch(e=>console.log(e));return}else if(t.target.value==="Show_all"){h();return}}function O(t){const e={openModalBtn:t,closeModalBtn:document.querySelector(".product-modal-close"),modal:document.querySelector(".product-backdrop")};e.openModalBtn.addEventListener("click",o),e.closeModalBtn.addEventListener("click",o);function o(){e.modal.classList.toggle("is-hidden")}}const P=document.querySelector(".product-list");document.querySelector(".product-modal-window");function l(t){P.innerHTML=I(t.results);const e=document.querySelector(".product-modal-open");console.log(e),e.addEventListener("click",O(e))}function I(t){return t.map(({_id:e,name:o,img:c,category:n,price:m,size:f,is10PercentOff:w,popularity:A})=>`
