import{s as C,a as d,b as i,c as b,d as S,e as $}from"./assets/sprite-163abfe1.js";import"./assets/vendor-a61d8330.js";const f="/Second_Team-project-2023/assets/discount-1f26b8b0.svg",T=document.querySelector(".popular-product-list");function q(t){T.insertAdjacentHTML("beforeend",_(t))}function _(t){return t.map(({_id:e,name:a,img:l,category:r,size:g,popularity:h})=>`
    ...
    `).splice(0,2).join("")}let I={email:"",products:[]};function p(){const t={keyword:null,category:null,byABC:!0,byPrice:null,byPopularity:null,page:1,limit:6};return localStorage.setItem("filterParams",JSON.stringify(t)),n()}function c(t){localStorage.setItem("filterParams",JSON.stringify(t))}JSON.parse(localStorage.getItem("shoppingCartItems"))||localStorage.setItem("shoppingCartItems",JSON.stringify(I));function B(){return JSON.parse(localStorage.getItem("shoppingCartItems")).products.length}function n(){return JSON.parse(localStorage.getItem("filterParams"))}const E=document.querySelector(".cart-number");E.insertAdjacentHTML("beforeend",B());const u=document.querySelector("#filterForm");u.addEventListener("submit",O);const D=document.querySelector("#categories");u.elements.filterCategories.addEventListener("change",J);u.elements.filterMethod.addEventListener("change",H);let o;function y(){o=n()?n():p()}y();function x(t){D.insertAdjacentHTML("afterbegin",F(t))}function F(t){const e=t.map(a=>`
    <option value="${a}" class="js-option">${a}</option>
    `);return e.unshift('<option value="" disabled selected>Categories</option>'),e.join("")}function O(t){t.preventDefault();const{filterInput:e,filterCategories:a}=t.target.elements;z(e,a)}function z(t,e){t.value.trim().length?t.value.trim()?(o.keyword=t.value.trim(),e.value!==""&&(o.category=e.value),c(o),i(n()).then(a=>{if(console.log(a),a.data.results.length)s(a.data);else if(!Array.isArray(a.data.results)||!a.data.results.length){w();return}}).catch(a=>console.log(a))):e.value&&(o.category=e.value.trim(),c(o),i(n()).then(a=>{if(a.data.results.length)s(a.data);else return}).catch(a=>console.log(a))):(p(),y(),d().then(({data:a})=>{s(a)}).catch(a=>console.log(a)),u.reset())}function J(t){t.preventDefault(),t.target.value==="Show all"&&(d().then(({data:e})=>{s(e)}).catch(e=>console.log(e)),u.reset()),o.category=t.target.value.replaceAll(" ","_"),c(o),i(n()).then(e=>{if(e.data.results.length)s(e.data);else if(!Array.isArray(e.data.results)||!e.data.results.length){w();return}}).catch(e=>console.log(e))}function H(t){if(t.preventDefault(),t.target.value==="A_to_Z"||t.target.value==="Z_to_A"){t.target.value==="A_to_Z"?o.byABC=!0:o.byABC=!1,c(o),i(n()).then(e=>{if(e.data.results.length)s(e.data);else return}).catch(e=>console.log(e));return}else if(t.target.value==="Cheap"||t.target.value==="Expensive"){t.target.value==="Cheap"?o.byPrice=!0:o.byPrice=!1,c(o),i(n()).then(e=>{if(e.data.results.length)s(e.data);else return}).catch(e=>console.log(e));return}else if(t.target.value==="Popular"||t.target.value==="Not_popular"){t.target.value==="Not_popular"?o.byPopularity=!0:o.byPopularity=!1,c(o),i(n()).then(e=>{if(e.data.results.length)s(e.data);else return}).catch(e=>console.log(e));return}else if(t.target.value==="Show_all"){p();return}}const L=document.querySelector(".product-list");function s(t){L.innerHTML=Z(t.results)}function Z(t){return t.map(({_id:e,name:a,img:l,category:r,price:g,size:h,is10PercentOff:k,popularity:A})=>`
        <div class="all-product-card" id="${e}">
         <img class="all-discount-svg
         ${k.toString().replace("false","visually-hidden")}
          " 
