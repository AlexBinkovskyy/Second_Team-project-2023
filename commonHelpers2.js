import{s as k,d as y,e as m,f as p,h as u,i as r,j as M,k as q,l as A,m as E,n as C}from"./assets/workWithCart-9829a0b8.js";import{P}from"./assets/vendor-b592f4c5.js";const w="/Second_Team-project-2023/assets/discount-1f26b8b0.svg",f="/Second_Team-project-2023/assets/check-ico-267a6277.svg",T=document.querySelector(".popular-product-list");async function D(t){T.insertAdjacentHTML("beforeend",_(t));const e=document.querySelector(".click-buy");e.addEventListener("click",()=>{e.style.display="none",a.style.display="block"});const a=document.querySelector(".popular-check")}function _(t){return t.map(({_id:e,name:a,img:n,category:s,size:c,popularity:i})=>`
    ...
    `);return e.unshift('<option value="" disabled selected>Categories</option>'),e.join("")}function O(t){t.preventDefault();const{filterInput:e,filterCategories:a}=t.target.elements;Z(e,a)}function Z(t,e){t.value.trim().length?t.value.trim()?(o.keyword=t.value.trim(),e.value!==""&&(o.category=e.value),p(o),u(r()).then(a=>{if(console.log(a),a.data.results.length)l(a.data);else if(!Array.isArray(a.data.results)||!a.data.results.length){g();return}}).catch(a=>console.log(a))):e.value&&(o.category=e.value.trim(),p(o),u(r()).then(a=>{if(a.data.results.length)l(a.data);else return}).catch(a=>console.log(a))):(y(),b(),m().then(({data:a})=>{l(a)}).catch(a=>console.log(a)),d.reset())}function Q(t){t.preventDefault(),t.target.value==="Show all"&&(m().then(({data:e})=>{l(e)}).catch(e=>console.log(e)),d.reset()),o.category=t.target.value.replaceAll(" ","_").replaceAll("&","%26"),p(o),u(r()).then(e=>{if(e.data.results.length)l(e.data);else if(!Array.isArray(e.data.results)||!e.data.results.length){g();return}}).catch(e=>console.log(e))}function G(t){if(t.preventDefault(),t.target.value==="Show_all"&&(y(),b(),m().then(({data:e})=>{l(e)}).catch(e=>console.log(e)),d.reset()),t.target.value==="A_to_Z"||t.target.value==="Z_to_A"){t.target.value==="A_to_Z"?o.byABC=!0:o.byABC=!1,o.byPrice=null,o.byPopularity=null,p(o),u(r()).then(e=>{if(e.data.results.length)l(e.data);else{g();return}}).catch(e=>console.log(e));return}else if(t.target.value==="Cheap"||t.target.value==="Expensive"){t.target.value==="Cheap"?o.byPrice=!0:o.byPrice=!1,o.byABC=null,o.byPopularity=null,p(o),u(r()).then(e=>{if(e.data.results.length)l(e.data);else{g();return}}).catch(e=>console.log(e));return}else if(t.target.value==="Popular"||t.target.value==="Not_popular"){t.target.value==="Not_popular"?o.byPopularity=!0:o.byPopularity=!1,o.byABC=null,o.byPrice=null,p(o),u(r()).then(e=>{if(e.data.results.length)l(e.data);else{g();return}}).catch(e=>console.log(e));return}else if(t.target.value==="Show_all"){y();return}}const R=document.querySelector(".product-modal-content"),$=document.querySelector("body");function U(t){const e={openModalBtn:t,closeModalBtn:document.querySelector(".product-modal-close"),modal:document.querySelector(".product-backdrop")};e.openModalBtn.addEventListener("click",a),e.closeModalBtn.addEventListener("click",n);function a(s){s.target.tagName==="BUTTON"?console.log("Buy button"):($.style.overflow="hidden",e.modal.classList.remove("is-hidden"),J(s.currentTarget)),console.log(s.target)}function n(){$.style.overflow="visible",R.innerHTML=`
