import{a as d}from"./vendor-a61d8330.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function i(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerpolicy&&(r.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?r.credentials="include":o.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(o){if(o.ep)return;o.ep=!0;const r=i(o);fetch(o.href,r)}})();const h="https://food-boutique.b.goit.study/api/products/",b="categories",v="popular",S="discount",c={MAIN_URL:h,categories:b,popular:v,discount:S};let $=1,u=6;async function P(){return window.innerWidth>=1440?u=9:window.innerWidth>=768?u=8:u=6,await d(`${c.MAIN_URL}?page=${$}&limit=${u}`)}async function w(){return await d(`${c.MAIN_URL}/${c.popular}?limit=5`)}async function L(){return await d(`${c.MAIN_URL}/${c.discount}`)}async function A(){return await d(`${c.MAIN_URL}/${c.categories}`)}const N=document.querySelector(".popular-product-list");function _(t){N.insertAdjacentHTML("beforeend",I(t))}function I(t){return t.map(({_id:e,name:i,img:s,category:o,size:r,popularity:n})=>`
    ...
    `).splice(0,2).join("")}const q=document.querySelector(".product-list");function k(t){q.innerHTML=F(t.results)}function F(t){return t.map(({_id:e,name:i,img:s,category:o,price:r,size:n,is10PercentOff:K,popularity:y})=>`
