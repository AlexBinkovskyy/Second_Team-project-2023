import{a as i}from"./vendor-8aa786c2.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function a(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerPolicy&&(n.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?n.credentials="include":e.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(e){if(e.ep)return;e.ep=!0;const n=a(e);fetch(e.href,n)}})();const I="https://food-boutique.b.goit.study/api/products",b="https://food-boutique.b.goit.study/api/subscription",S="categories",w="popular",C="discount",r={MAIN_URL:I,SECOND_URL:b,categories:S,popular:w,discount:C},h="/Second_Team-project-2023/assets/sprite-efb7e146.svg",p="/Second_Team-project-2023/assets/modal-sbscr@1x-min-21f87fae.png",N="/Second_Team-project-2023/assets/modal-sbscr@2x-min-2142accc.png";let $=1,m=6;async function J(){return window.innerWidth>=768&&(m=8,window.innerWidth>=1440&&(m=9)),await i(`${r.MAIN_URL}?page=${$}&limit=${m}`)}async function A(){return await i(`${r.MAIN_URL}/${r.popular}?limit=5`)}async function x(){return await i(`${r.MAIN_URL}/${r.discount}`)}async function T(t){return await i(`${r.MAIN_URL}/${t}`)}async function k(t){return await i(`${r.MAIN_URL}/${t}`)}async function D(){return await i(`${r.MAIN_URL}/${r.categories}`)}async function R({keyword:t=null,category:o=null,byABC:a=null,byPrice:s=null,byPopularity:e=null,page:n=1,limitPerPage:c=6}){window.innerWidth>=1440?c=9:window.innerWidth>=768&&(c=8);let l="https://food-boutique.b.goit.study/api/products?";return t&&(l+=`keyword=${t}&`),o&&(l+=`category=${o}&`),a!==null&&(l+=`byABC=${a}&`),s!==null&&(l+=`byPrice=${s}&`),e!==null&&(l+=`byPopularity=${e}&`),l+=`page=${n}&limit=${c}`,await i(l)}async function v(t){return i.post(`${r.SECOND_URL}`,{email:t})}async function U(t){return await i.post("https://food-boutique.b.goit.study/api/orders",t)}function f(t,o){document.querySelector("[data-modal]").classList.remove("is-hidden")}const g=document.querySelector(".modal");function u(){document.querySelector("[data-modal]").classList.add("is-hidden")}const L=document.getElementById("subscriptionForm");L.addEventListener("submit",async function(t){t.preventDefault();const a=document.getElementById("emailInput").value;v(a).then(s=>{s.data,s.status===201&&(f(),g.innerHTML=P(),document.querySelector("[data-modal-close]").addEventListener("click",u))}).catch(s=>{s.response,s.response.status===409&&(f(),g.innerHTML=O(),document.querySelector("[data-modal-close]").addEventListener("click",u))})});function P(){return`
...
//# sourceMappingURL=workWithCart-c49fbe6d.js.map
