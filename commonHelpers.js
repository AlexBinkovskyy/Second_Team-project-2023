import{g as a,r as M,a as C,b as T,u as H,s as w,c as k,p as F}from"./assets/workWithCart-c49fbe6d.js";import"./assets/vendor-8aa786c2.js";const i=document.querySelector(".js-cart-list"),O=document.querySelector(".cart-form-input"),p=document.querySelector(".js-total-summ"),L=document.querySelectorAll(".js-cart-numbers"),A=document.querySelector(".js-clear-order-btn"),h=document.querySelector(".js-cart-box"),y=document.querySelector(".js-empty-cart");let B=0,o=a(),c=null;_();i.addEventListener("click",t=>{if(t.target.classList.contains("delete-btn")){let e=t.target.closest(".selectedProduct");M(e.dataset.id);const n=o.products.findIndex(r=>r.id===e.dataset.id);console.log("index",n),n!==-1&&(o.products.splice(n,1),c.splice(n,1)),console.log(o),console.log(c),d()}});A.addEventListener("click",()=>{C(),o.products=[],c=[],d()});async function _(){o=a(),p.textContent="$0";const t=o.products.length;if(P(t),t){i.innerHTML="";const e=await D(o.products);c=e,x(L,t),S(e),p.textContent="$"+q(e).toFixed(2)}O.value=o.email}async function d(){o=a();const t=o.products.length;P(t),t&&(p.textContent="$"+q(c).toFixed(2),i.innerHTML="",S(c)),x(L,t)}function S(t){z(t,N).then(e=>{i.insertAdjacentHTML("beforeend",e)})}async function z(t,e){return t.map(n=>(B+=n.price,e(n))).join("")}async function D(t){return await Promise.all(t.map(({id:e})=>T(e).then(n=>n.data)))}function N(t){const{_id:e,name:n,img:r,category:f,price:l,size:E}=t;let g=null;try{g=o.products[o.products.findIndex(u=>u.id===e)].amount}catch(u){return console.log(u),""}const I=f.replace(/_/g," ");return`
  ...
  </li>`}let s;i.addEventListener("click",function(t){const e=a();let n="",r="";if(t.target.dataset.action==="increment"||t.target.dataset.action==="decrement")n=t.target.closest(".selectedProduct"),r=o.products.findIndex(l=>l.id===n.dataset.id),s=t.target.closest(".counter-container").querySelector(".counter-value");else return;t.target.dataset.action==="increment"&&(s.innerHTML=++s.innerHTML),t.target.dataset.action==="decrement"&&parseInt(s.innerHTML)>1&&(s.innerHTML=--s.innerHTML),H(e.products[r].id,s.innerHTML),d()});function P(t){U(h,y),v(t?h:y)}function v(...t){t.forEach(e=>{e.classList.remove("hiden")})}function U(...t){t.forEach(e=>{e.classList.add("hiden")})}function x(t,e){t.forEach(n=>{n.textContent=e})}function q(t){return t.reduce((e,n)=>e+n.price*o.products[o.products.findIndex(r=>r.id===n._id)].amount,0)}const b=document.querySelector(".cart-form"),W=document.querySelectorAll(".js-modal-close"),j=document.querySelector(".success-modal"),$=document.querySelector(".fail-modal");b.addEventListener("submit",t=>{t.preventDefault(),k(b.elements.email.value);const e=a();e.products=e.products.map(({id:n,amount:r})=>({productId:n,amount:r})),F(e).then(n=>{n.status===201?(console.log(n.data.message),m(!0),C(),d()):m(!1)}).catch(n=>{m(!1)})});W.forEach(t=>t.addEventListener("click",G));function m(t){t?j.classList.remove("hiden"):$.classList.remove("hiden")}function G(t){j.classList.add("hiden"),$.classList.add("hiden")}
